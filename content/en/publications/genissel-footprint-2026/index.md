...
summary: In the face of rapid global change and awareness of the strong evolutionary impact of humans on the biosphere, we promote a more systematic vision for measuring the impact of a driver. To go beyond the Ecological or Biodiversity Footprint, we propose the Evolutionary Footprint framework. The evolutionary footprint aims to identify and quantify the impact of a driver on the evolutionary trajectory of a biological entity. This indicator integrates both macro- and micro-evolution for a more accurate and holistic approach at all integrative, temporal and spatial scales. In particular, this framework could help to account for and reduce the impact of humans on the evolutionary trajectories of living organisms in an evocentric approach to biodiversity conservation.  
